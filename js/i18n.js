...
export const translations = {
  en: {
    ...
    rename_exercise_title: "Rename Exercise",
    rename_exercise_hint: "All logged sets and history for this exercise will be kept under the new name.",
    ...
    toast_program_duplicated: "Program duplicated",
    toast_day_created: "Workout day created",
    toast_day_updated: "Day updated",
    toast_exercise_renamed: "Exercise renamed",
    toast_exercise_name_taken: "An exercise with this name already exists in this day",
    toast_day_deleted: "Day deleted",
    toast_day_duplicated: "Day duplicated",
  ...
  bg: {
    ...
    rename_exercise_title: "Преименувай упражнение",
    rename_exercise_hint: "Всички записани серии и историята на упражнението ще бъдат запазени под новото име.",
    ...
    toast_program_duplicated: "Програмата е дублирана",
    toast_day_created: "Тренировъчният ден е създаден",
    toast_day_updated: "Денят е обновен",
    toast_exercise_renamed: "Упражнението е преименувано",
    toast_exercise_name_taken: "Упражнение с това име вече съществува в този ден",
    toast_day_deleted: "Денят е изтрит",
    toast_day_duplicated: "Денят е дублиран",
